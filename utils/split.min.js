!(function (D, u) {
        ...
        ((d = (l = o[E]).parentNode === D) || G || (q && !P)) &&
          ...
          k &&
            (((l._isSplit && d) ||
              ...
              (a.push(l), (l._x -= _), z(l, D, j) && (l._wordEnd = !0)),
            "BR" === l.nodeName &&
              ((l.nextSibling && "BR" === l.nextSibling.nodeName) || 0 === E) &&
              k.push([])));
    for (E = 0; E < r; E++)
      if (((d = (l = o[E]).parentNode === D), "BR" !== l.nodeName))
        if (
          ...
          if (l._isSplit)
            for (
              l._next = s = l.nextSibling, l.parentNode.appendChild(l);
              s && 3 === s.nodeType && " " === s.textContent;
          ...
          l.parentNode._isSplit && !l._isSplit && "" !== l.innerHTML
            ...
            : q &&
              !l._isSplit &&
              ("span" === M && (l.style.display = "inline"), W.push(l));
      else
        k || G
          ? (l.parentNode && l.parentNode.removeChild(l), o.splice(E--, 1), r--)
          : P || D.appendChild(l);
      ...
      for (h = " " === j && (!G || (!P && !q)), E = 0; E < k.length; E++) {
        for (
          ...
          "BR" !== a[s].nodeName &&
            ...
            G &&
              (0 === s &&
                ((c.style.top = l._y + "px"), (c.style.left = _ + m + "px")),
              (l.style.top = "0px"),
  ...
  function D(D, e, F, C) {
    ...
    for (
      ...
      if (((l = i.charAt(E)), g && (d = g(i.substr(E), e.specialChars))))
        (l = i.substr(E, d || 1)),
          (n += a && " " !== l ? C() + l + "</" + p + ">" : l),
          (E += d - 1);
  ...
  function E(u, e, F, C) {
    var i,
      ...
      o = t(e);
    if (3 !== u.nodeType || 1 < l) {
      for (e.absolute = !1, i = 0; i < l; i++)
        ((n = r[i])._next = n._isFirst = n._parent = n._wordEnd = null),
